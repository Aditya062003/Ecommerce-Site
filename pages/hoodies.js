  ...
  return (
    ...
    <div class="container py-24 m-auto ">
      <div class="flex flex-wrap justify-center">
        ...
        <div class="lg:w-1/5 cursor-pointer m-4 shadow-md hover:shadow-xl md:w-1/2 p-4 w-full">
          <a class="block relative rounded overflow-hidden">
            <img alt="ecommerce" class="h-[36vh] m-auto" src="https://m.media-amazon.com/images/I/51kkXROd+2L._AC_UL480_FMwebp_QL65_.jpg"/>
          </a>
        ...
        <div class="lg:w-1/5 cursor-pointer m-4 shadow-md hover:shadow-xl md:w-1/2 p-4 w-full">
          <a class="block relative rounded overflow-hidden">
            <img alt="ecommerce" class="h-[36vh] m-auto" src="https://m.media-amazon.com/images/I/71r+PiHnBTL._AC_UL480_FMwebp_QL65_.jpg"/>
          </a>
          <div class="mt-4 text-center">
            <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">T-Shirts</h3>
